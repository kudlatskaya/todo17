...
test('correct task should be deleted from correct array', () => {
    ...
    const action = tasksThunks.removeTask.fulfilled(payload, '', payload)
...
//     const action = tasksActions.addTodolist({
//         todolist: {
//             id: 'blabla',
//             title: 'new todolist',
//             order: 0,
...
//     const action = tasksActions.removeTodolist({ todolistId: 'todolistId2' })
//
//     const endState = tasksReducer(startState, action)
//
//     const keys = Object.keys(endState)
...
//     const action = tasksActions.setTodolists({
//         todolists: [
